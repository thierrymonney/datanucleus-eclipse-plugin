...
2007 Andy Jefferson - support input file suffix specification
    ...
**********************************************************************/
package com.datanucleus.ide.eclipse.jobs;
...
import com.datanucleus.ide.eclipse.Plugin;
import com.datanucleus.ide.eclipse.preferences.PreferenceConstants;
import com.datanucleus.ide.eclipse.preferences.SchemaToolPreferencePage;
import com.datanucleus.ide.eclipse.project.ProjectHelper;
import com.datanucleus.ide.eclipse.wizard.schematool.SchemaToolModel;
...
public class SchemaToolJob extends Job implements IDebugEventSetListener
{
    ...
    protected ILaunch createLaunch() throws CoreException
    {
        ...
        return LaunchUtilities.launch(javaProject, NAME, MAINCLASS, classpath, vmArgs, workingDir, programArgs, MAINCLASS);
    }
